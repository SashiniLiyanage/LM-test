...
class UpdateLibrary extends React.Component {
  constructor(props) {
    ...
    this.state = {
      licenses: [],
      libLicenseID: [],
      licenseID: this.props.data.licenseID,
      libType: this.props.data.LIB_TYPE,
      libFilename : this.props.data.LIB_FILENAME,
      packName : this.props.data.PACK_NAME,
  ...
  updateLibrary = () => {
    axios.post(process.env.REACT_APP_BE_URL + '/LicenseManager/addLibraryLicense/'+this.state.packName, this.state,
    {
      headers:{
    ...
    fetch(process.env.REACT_APP_BE_URL + '/LicenseManager/getLicense', {
      ...
      .then((data) => {
        ...
        data.forEach(element => {
          if(this.state.licenseID.includes(element.LIC_ID)){
            value.push({
              value: element.LIC_ID,
              label: element.LIC_KEY,
            })
          }
        });
